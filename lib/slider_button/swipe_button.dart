...
class SwipeButtonState extends State<SwipeButton>
  ...
  void initState() {
    ...
    _contentAnimation = Tween<double>(begin: 1.0, end: 0)
        .animate(CurvedAnimation(parent: _controller, curve: Curves.easeOut));
    if (widget.initialPosition == SwipePosition.SwipeRight) {
      _controller.value = 1.0;
    }

    _contentAnimation.addListener(() {
      if (_contentAnimation.value == 0) {
        setState(() {});
      } else if (_contentAnimation.value == 1.0) {
        setState(() {});
      }
    });
  }
        ...
        children: <Widget>[
          DecoratedBox(
            decoration: BoxDecoration(
              ...
              borderRadius: new BorderRadius.all(new Radius.circular(9999)),
            ),
            child: ClipRRect(
          ...
          AnimatedBuilder(
            ...
            child: GestureDetector(
              ...
              child: _contentAnimation.value < 0.8
                  ? Hero(
                      tag: "swipe",
                      child: Icon(
                        Icons.check_circle,
