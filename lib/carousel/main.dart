...
class _CarouselWithIndicatorState
    extends State<CarouselWithIndicator> {
  int _current = 0;
...
class CarouselDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final CarouselSlider manualCarouselDemo =
        CarouselSlider(
      items: child,
      autoPlay: false,
    ...
    final CarouselSlider coverScreenExample =
        CarouselSlider(
      viewportFraction: 1.0,
      aspectRatio: 2.0,
      autoPlay: false,
    ...
    final CarouselSlider touchDetectionDemo =
        CarouselSlider(
      viewportFraction: 0.9,
      aspectRatio: 2.0,
      autoPlay: true,
    ...
    final CarouselSlider nonLoopingCarousel =
        CarouselSlider(
      items: child,
    ...
    //Vertical carousel
    final CarouselSlider verticalScrollCarousel =
        CarouselSlider(
    ...
    CarouselSlider getFullScreenCarousel(
      ...
      return CarouselSlider(
        ...
        viewportFraction: 1.0,
        aspectRatio:
            MediaQuery.of(mediaContext).size.aspectRatio,
        items: imgList.map(
          (url) {
            return Container(
              child: ClipRRect(
    ...
    CarouselSlider getOnDemandCarousel(
        BuildContext mediaContext) {
